...
{
    private static S_Game _instance;

    public static S_Game Ins
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<S_Game>();
                if (null == _instance)
                {
    ...
    public Vector2 _closedShutter = new Vector2(540, 1425);
    ...
    //void GameOver()
    //{
    //    PlayerPrefs.SetInt("Combo", Speed.Ins._Combo);
    //    PlayerPrefs.SetInt("Money", Speed.Ins._Money);

    //    PlayerPrefs.SetInt("Speed1", Speed.Ins._Speed);
    //    if (Speed.Ins._Speed >= Speed.Ins._BESTSpeed)
    //    {
    //        Speed.Ins._BESTSpeed = Speed.Ins._Speed;
    //        PlayerPrefs.SetInt("Speed", Speed.Ins._BESTSpeed);
    //    }

    //    Speed.Ins._ORDERNUM.text = "" + Speed.Ins._ordernum.ToString();
    //    Speed.Ins._BESTSPEEDNUM.text = "" + Speed.Ins._BESTSpeed.ToString();
    //    Speed.Ins._Reward.text = "" + string.Format("{0:#,###0}", Speed.Ins._Money.ToString());
    //    Speed.Ins._ComboText.text = "" + Speed.Ins._Combo.ToString();
